...
const ViewStrike = () => {
  ...
  const getAllData = async () => {
    ...
    await globalRequest(
      API_ROUTES?.GETALLSTUDENTSTRIKESTUDENT,
      "get",
      {},
      { params: params },
      true
  ...
  const approveStatus = async (id) => {
    ...
    await globalRequest(
      API_ROUTES?.CHANGEOFSTATUSSTRIKEDATA + "/" + id,
      "put",
      data,
      {},
      true
                ...
                <tbody>
                  {loading ? (
                    ...
                    listData?.map((item, index) => (
                      <tr key={index}>
                        <td>{
                        item?.AddedByUser?.company_institutes[0]?.company_institute_name
                        }</td>
                        <td>
                        ...
                        <td>
                          {item?.StrikeForUser?.first_name}{" "}
                          {item?.StrikeForUser?.last_name}
                        </td>
                        <td>
                          <span
