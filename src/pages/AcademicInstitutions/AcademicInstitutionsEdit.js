...
const AcademicInstitutionsEdit = () => {
        ...
        <div className="adminContent">
          <div className="tablefilterheader p-4">
            <div className="tableHeader">
              ...
              />
              <h4 className="h4 mb-0"> Edit Academic Institutions </h4>
            </div>
          </div>
             ...
             <div className="grid ">
              ...
              <div className="lg:col-5 md:col-5 sm:col-12 py-0">
                <div className="formField companyBillingAddress">
                  ...
                  <div className="country-city-selector mt-2">
...
export default AcademicInstitutionsEdit;
