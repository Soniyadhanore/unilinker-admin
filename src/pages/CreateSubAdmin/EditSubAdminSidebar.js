      ...
      .then((res) => {
        if (res.ack === 1) {
          ...
          setFormData({
            ...
            email:data.email,
            country_code_str:data.country_code_str,
            country_code:data.country_code,
            mobile:data.country_code+data.mobile,
            designation:data.employees[0].designation,
            role_id:{ name :data.employees[0].role.role_name ,code:data.employees[0].role_id }
          })
        }
      })
      .catch((err) => {
      ...
      <div className="adminContent">
        <div className="tablefilterheader">
          <div className="tableHeader">
            ...
            />
            <h4 className="h4 mb-0"> Edit Sub Admin Account</h4>
          </div>
        </div>
...
export default EditSubAdminSidebar;
