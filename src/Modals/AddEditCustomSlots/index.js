...
import { slotTimeValidationForCustom, generateHours, convertTimeTo12Hour } from "../../common/HelperFunctions";
import FormSelect from 'react-bootstrap/FormSelect'

const AddEditCustomSlots = ({
  open,
  onClose,
  setStep2Data,
  step2Data,
  ...
  useEffect(() => {
    ...
    console.log('asdasdasdasd', validation);
      ...
      >
        <div className="w-full max-w-[588px] p-3">
          ...
          {slots[slotDay]?.map((slot, index) => {
            return (
              <div key={index} className="flex gap-3 align-items-center mb-[20px] mt-3">
...
export default AddEditCustomSlots;
